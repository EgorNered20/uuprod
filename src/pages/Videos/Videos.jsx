...
const Videos = ({img, index}) => {
    return (
            <div className="lg:w-1/3 sm:w-1/2 p-4" bis_skin_checked={1}>
                    ...
                    >
                        ...
                        <div className='flex justify-center'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="115" height="115" fill="currentColor" class="bi bi-play-circle" viewBox="0 0 16 16">
